...
class Quiz {
    ...
    generateChoices() {
        ...
        this.questionElement.textContent = question.column;
    ...
    checkAnswer(choice) {
        ...
        if (choice === correctAnswer) {
            ...
            this.eachQResultElement.textContent = "正解！";
            this.correctAnswers++;
        } else {
            this.music.wrong.currentTime = 0;
            this.music.wrong.play();
            this.eachQResultElement.textContent = `不正解。正解は「${correctAnswer}」でした。`;
        }
        this.currentQuiz++;
        this.waiting = true;
